...
clickHandler();  // "calling clickHandler"
...
class Workshop {
    ...
    ask(question) {
        console.log(this.teacher + ' asks: ' + question);
    }
}

let deepJS = new Workshop("Kyle");
deepJS.ask("Do these jeans make me look fat?");